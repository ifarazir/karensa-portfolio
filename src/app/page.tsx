    ...
    projects: [
      {
        ...
        description:
          "پت‌شاپ ژیوان با شعار «ژیوان، دوست حیوان و انسان»، به‌عنوان بزرگ‌ترین فروشگاه ملزومات و غذای حیوانات‌خانگی در ایران با همفکری و کارشناسی تیمی باتجربه و دوستدار محیط‌زیست و حیوانات، اولین شعبه‌ی خود را در سال 1394 در خیابان ولی‌عصر تهران تأسیس کرد و در مدتی کوتاه",
      ...
      },
      {
        ...
        description:
          "«دنیلی» نماینده ی کوچک و موفقی از مهد دنیای مد و زیبایی، ایتالیا است. دنیلی برندی است که توانسته به خوبی ترندهای روز دنیا و هنر اصیل ایتالیایی را همراه کند و با شناخت نیاز مردم، محصولاتی جذاب و خاص طراحی کند.",
        technologies: [
          "Android",
          "iOS",
          "Cloud Solutions",
      ...
      },
      {
        ...
        title_badge: "v2",
        description:
          "Omnicart یک راه حل همه کاره است که به شما کمک می کند تجارت پذیرایی خود را توسعه دهید، عملیات را ساده کنید و سود خود را حفظ کنید.",
      ...
      },
      {
        ...
        title: "Fundracing",
        description:
          "فاندریسینگ یک تیم بین المللی تشکیل شده از افراد با تجربه در بازار مالی است که سرمایه مورد نیاز تریدر ها را تامین کرده و از تریدر های برتر و با استعداد حمایت میکنید.",
        technologies: [
          "NextJS",
          "Shadcn/ui",
          "SEO",
      ...
      },
      {
        ...
        description:
          "گروه هایک با استفاده از بهترین دانه‌های‌ قهوه‌ و به‌روزترین تکنیک‌های برشته‌کاری، سعی دارد تا شما هارمونی منحصربه‌فرد  طعم‌ها را در فنجان قهوه‌ی خود تجربه کنید.",
        technologies: ["Wordpress", "SEO", "Elementor", "Server optimization"],
      ...
      {
        index: 80,
        title: "نرم افزار ERP مبلمان زیکس",
        description:
          "شرکت زیکس با سابقه چندین ساله فعال در زمینه تولید انواع مبلمان و اکسسوری های خاص واقع در منطقه صنعتی سیاهسنگ",
      ...
      },
      {
        ...
        description:
          "نرم افزار مدیریت مشتریان طلا با اتصال مستقیم به اسنپ فود و همگام سازی با دستگاه‌های مجموعه شیرینی‌فروشی‌های زنجیره‌ای الهیه ۳۳، ارتباط با مجموعه با مشتری و فروش روزانه مجموعه فوق را بهبود بخشیده است.",
        technologies: [
          "NextJS",
          "Shadcn/ui",
          "ElasticSearch",
      ...
      },
      {
        ...
        title: "فلی",
        description:
          "ما در تلاش هستیم تا تجربه‌ای را ارائه دهیم که ماهیت لباس‌های ژاپنی ساده، راحت، جادار و کاربردی را در بر گیرد.",
        technologies: ["Wordpress", "SEO", "Elementor", "Server optimization"],
      ...
      },
      {
        ...
        title: "تهران زین",
        description:
          "تهران زین در سال ۱۴۰۰ با هدف فراهم کردن امکان تولید و نشر “زین” به عنوان رسانه‌ای شناخته شده و پر اهمیت در جهان برای هنرمندان جوان ایرانی بنا نهاده شد.",
        technologies: ["Wordpress", "Elementor"],
      ...
      },
      {
        ...
        description:
          "شرکت فعال در حوزه تشریفات و مراسم عروسی با تجربه چند دهده در این  زمینه و فعال در کشور های ترکیه، امارات و ایران.",
        technologies: ["Wordpress", "Elementor"],
      ...
      },
      {
        ...
        description:
          "کافه گالری فعال در شهر تهران محدوده فلسطین که از سال ۱۴۰۳ فعالیت خود را آغاز کرده است.",
  ...
  },
  {
    ...
    projects: [
      ...
      },
      {
        ...
        title: "صرافی کیوسک",
        description:
          "صرافی کیوسک محصول شرکت کیمیاگران سرمایه همراه ایرانیان است. این صرافی در سال 1400 فعالیت خود را در شهر تهران آغاز کرد. بر اساس اطلاعات درج شده در سایت رسمی صرافی کیوسک، این صرافی بیش از 200 هزار کاربر فعال دارد. همچنین اپلیکیشن موبایل اندروید و iOS این صرافی هم در دسترس کاربران است.",
        technologies: [
          "React",
          "Tailwind",
          "ReactRouter",
      ...
      },
      {
        ...
        title: "زینوم",
        description:
          "سرویس زینوم با هدف کاهش سرعت پیر شدن (aging) و افزایش عمر سالم شما طراحی شده است.",
        technologies: ["Wordpress", "Elementor"],
      ...
      },
      {
        ...
        description:
          "رستوران آپادانا فضایی دنج، گرم و آرام دارد و در شهر وین اتریش واقع شده است. در این رستوران انواع غذاهای حلال خوشمزه از جمله گریل، کباب، برنج زعفرانی، کورما، مرغ کبابی و بسیاری از غذاهای خوشمزه دیگر ارائه می شود",
        technologies: ["Wordpress", "Elementor"],
    ...
    projects: [
      {
        ...
        description:
          "آکادمی آهی محیطی پویا و مناسب برای افراد مستعد و با انگیزه رشد در زمینه بازارهای مالی است. شما در آکادمی آهی همزمان با کار در حوزه تخصصی خود از مزایای آموزش های بازارهای مالی(بورس- بازارهای جهانی و ارزهای دیجیتال) بهره مند خواهید شد.",
    ...
    projects: [
      {
        ...
        description:
          "یونیلیور صاحب بسیاری از برندهای معروف دنیا در دسته بندی های غذایی، نوشیدنی، تمیزکننده های محیطی و نظافت شخصی صابون لوکس، چای لیپتون، شامپوهای کلییر، سان سیلک و داو ، شوینده های سیف، دامستوس، امو و ... می باشد.",
        technologies: ["Wordpress", "Elementor"],
      ...
      },
      {
        ...
        title: "فیناپ",
        description:
          "نخستین رویداد تخصصی در حوزه فناوری‌ھای مالی (فین‌تک) که یک کامیونیتی بزرگ را گردهم آورده است. رویداد فیناپ در خردادماه سال ۱۳۹۶ با سه هدف آموزش، شبکه‌سازی و توسعه فین‌تک به سراسر کشور با برگزاری رویدادهای ماهانه آغاز به کار کرد.",
        technologies: ["Wordpress", "Elementor"],
      ...
      },
      {
        ...
        description:
          "جامع‌ترین مرجع مصور در زمینه تشخیص آزمایشگاهی برای پزشکان و دانشجویان پزشکی به سفارش شرکت پل ایده آل پارس",
      ...
      },
      {
        ...
        description:
          "بهینه‌پردازان راهکارهایی برای کاهش مراجعات حضوری و تسهیل امور مودیان طراحی شده است و نقش مهمی در کاهش خطاهای پرونده‌های مالیاتی دارد.",
        technologies: ["Wordpress", "Elementor"],
    ...
    projects: [
      {
        ...
        title: "آوید فوم",
        description:
          "آوید فوم یک تولید کننده داخلی بردهای فومی است که محصولاتش در طیف گسترده ای از زمینه ها از قبیل چاپ دیجیتال ، چاپ مسطح ، استندهای تبلیغاتی نمایشگاهی و فروشگاهی ، برش گرافیکی و علائم در محیط های داخلی استفاده می شود.",
    ...
    projects: [
      {
        ...
        description:
          "شرکت پل ایده آل پارس (P.I.P) دارنده گواهی نامه های مدیریت کیفیت ISO 13485:2016 و ISO 9001:2015 با بیش از سه دهه تجربه در امور تولید ، توزیع و فروش محصولات پزشکی و آزمایشگاهی در راستای پیشبرد سلامت جامعه فعالیت می نماید.",
    ...
    projects: [
      {
        ...
        title: "Nestous",
        description:
          "تولید کننده آینه‌های هوشمند مناسب فضاهای آرایشگاهی و سالن‌های زیبایی، فعال در کشور کانادا، هلند و دانمارک",
      ...
      },
      {
        ...
        description:
          "موسیقی هنر ، مرجع اطلاع رسانی اخبار اکران فیلم های سینمایی ، تئاتر ها و موارد دیگر مرتبط با هنر به زبان فارسی همراه با اطلاع رسانی تخفیف کنسرت ها.",
        ...
        <nav className="hidden flex-col md:flex md:flex-row md:items-center md:justify-between w-full h-full border-b">
          <Link className="flex items-center gap-2 font-semibold" href="/">
            ...
            <div className="flex flex-col">
              ...
              <p className="text-xl font-bold -mt-1">Karensa Studio</p>
            </div>
          </Link>
        ...
        <div className="flex items-end justify-between mb-12">
          <div className="flex flex-col">
            ...
            <p className="text-muted-foreground mt-1">
              معرفی تکنولوژی‌های مورد استفاده و موضوع فعالیت‌ها
            </p>
          </div>
